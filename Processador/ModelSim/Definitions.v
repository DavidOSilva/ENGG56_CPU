...
`define STATE_FETCH_DATA_TO_STACK 5'h9
`define STATE_PREPARE_PUSH_TO_STACK 5'hA
`define STATE_PUSH_TO_STACK 5'hB
`define STATE_CONFIG_DATA_MEM_READ 5'hC
`define STATE_DATA_MEM_READ 5'hD
`define STATE_CONFIG_INST_MEM_READ 5'hE
`define STATE_INST_MEM_READ 5'hF
`define STATE_PREPARE_SEND_TO_RAM 5'h10
`define STATE_SEND_TO_RAM 5'h11
